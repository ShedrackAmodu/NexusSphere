...
SECRET_KEY = "django-insecure-$(foxl7=20#w*4-e)8%tbqql#a!8kal*2luu46f#b9rku9k9i^"
...
# Development email backend: prints emails to console (useful for password reset flow)
